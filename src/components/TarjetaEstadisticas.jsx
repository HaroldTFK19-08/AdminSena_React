 ...
 * Muestra un indicador numérico con un icono y color personalizado.
 */
export default function TarjetaEstadistica({ etiqueta, valor, icono, color = "text-emerald-600", fondoColor = "bg-emerald-100" }) {
    return (
        <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-md transition-all duration-300 group">
            <div className="flex items-center justify-between">
                ...
                <div className={`w-14 h-14 ${fondoColor} ${color} rounded-2xl flex items-center justify-center text-2xl shadow-inner transform group-hover:rotate-12 transition-transform duration-300`}>
