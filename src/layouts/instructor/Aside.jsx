...
const ENLACES_PRINCIPALES = [
    ...
    {
        to: "/instructor/aprendices",
        nombre: "Aprendices",
        icono: "bi-people-fill",
    },
    {
        to: "/instructor/ambientes",
        nombre: "Ambientes",
...
const ENLACES_SISTEMA = [
    {
        to: "/instructor/reportes",
        nombre: "Reportes",
        icono: "bi-bar-chart-fill",
    },
    {
        to: "/instructor/configuracion",
        ...
        <li>
            ...
            >
                {({ isActive }) => (
                    <>
                        {isActive && (
                            <span className="absolute left-0 top-2 bottom-2 w-[3px] rounded-r-full bg-[#8AFD5D]" />
                        )}
...
export default function AsideInstructor() {
            ...
            >
                ...
                >
                    <div className="w-12 h-12 rounded-xl bg-white/[0.04] border border-white/[0.08] flex items-center justify-center shrink-0">
                        <span className="text-[#8AFD5D] font-black text-lg">
                            <img src={Logo} alt="logo-admin-sena" />
                        </span>
                    </div>
                    {!collapsed && (
